...
| Microsoft 365 admin center | https://admin.cloud.microsoft | Package upload and agent inventory |
...
This extracts a set of manifest templates into `manifest/`, updates the ids in them, and packages the result as `manifest/manifest.zip`. Upload that file at **https://admin.microsoft.com** → **Agents** → **All agents** → **Upload custom agent**.
...
Request an agent instance, then wait for a tenant administrator to approve it here:
