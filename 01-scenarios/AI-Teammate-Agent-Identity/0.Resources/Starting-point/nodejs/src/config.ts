...
export interface Settings {
    ...
    /**
     * Activities arrive on /api/messages on this port. 3982 keeps this agent clear of the
     * other three samples in the repository, which use 3978 to 3981, so they can all run
     * at the same time. Whatever you pick here is the port the dev tunnel forwards to, and
     * the tunnel url is what Phase 1 registers on the blueprint.
     */
    port: number;
}
...
export const settings: Settings = {
    ...
    port: Number(optional("PORT") ?? 3982),
};
