...
**Scenario Type**: Onboarding an existing web-hosted agent into Microsoft Agent 365
...
Two are provided, functionally identical:
...
Both are Microsoft Learn research assistants: they answer questions about Microsoft products by
searching the official [Microsoft Learn MCP server](https://learn.microsoft.com/api/mcp) and
citing what they retrieved. Neither contains a single line of Agent 365 code.
